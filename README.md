...
At `python: 'function name'` and `js: 'function name'` you state the name your function (line 11, 12).    
It's **not necessary** to change it.   
Further description of this will be added later.   
...
At `python: 'function name'` and `js: 'function name'` (line 41 and 42) you can state your function's name, to which the arguments you listed at **test.py** will be parsed for testing.
