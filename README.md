...
Line 41: `python: 'function name'` and line 42: `js: 'function name'`.    
Here, at `'function name'` you can state the identifier of your function, to which the arguments you listed at **test.py** will be parsed for testing.
